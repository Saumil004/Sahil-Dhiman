          ...
          <div className="bg-white/5 rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {[
                ...
                { name: 'password', placeholder: 'Password (min 6 characters)', type: 'password', icon: (
            ...
            >
              <p className="text-gray-400 text-sm">
                ...
                <span
                  ...
                  className="text-lime-300 font-medium hover:text-emerald-400 cursor-pointer transition"
                >
                  Sign in
                </span>
              </p>
